...
export async function getInitialState(): Promise<{
  ...
  // loading?: boolean;
  // fetchUserInfo?: (
  //   loginData: API.AdminLoginDto,
  // ) => Promise<{ token?: string; userInfo?: API.User } | undefined>;
}> {
  let currentUser: CurrentUser | null = null;
  // const fetchUserInfo = async (loginData: API.AdminLoginDto) => {
  //   try {
  //     const loginRes = await adminLogin(loginData);
  //     if (loginRes.code === 200) {
  //       currentUser = loginRes.data;
  //       return loginRes.data;
  //     } else message.error(loginRes.message);
  //   } catch (error) {
